...
Status: **MECÁNICA_CERRADA A / PUBLICADO**. Existing historical declarations are compatible with the reconstructed ABI; no callable contract was invented from the symbol map.
